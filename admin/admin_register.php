...
<head>
    ...
    <title>TMS | Admin Registration Page</title>
    <!-- jQuery File -->
...
<body>
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
            <div class="col-md-3 m-auto" id="registration_home_page">
                <center><h3 style="background-color: rgb(199, 230, 240); padding: 5px;">Admin Registration</h3></center>
                <form action="" method="post"> 
                    <div class="form-group">
                        <input type="text" name="name" class="form-control" placeholder="Enter Name" required style="margin-top: 20px;">
                    </div>
                    <div class="form-group">
                    ...
                    <center>
                        <div class="form-group">
                            <input type="submit" name="adminRegistration" value="Register" class="btn btn btn-warning" style="margin-top: 20px;"> 
                        </div>
                    </center>
                </form>
                <br>
